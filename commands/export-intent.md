---
name: export-intent
description: Force an immediate behavioral model export from recent Claude Code transcripts to EDAMAME Security.
---

# Export Intent Now

Trigger an immediate behavioral model refresh from recent Claude Code transcripts.

## Steps

1. Use the `edamame_claude_code_control_center_refresh_now` MCP tool to:
   - Read recent Claude Code session transcripts
...
3. If the export fails, check:
   ...
   - Are there recent Claude Code transcripts to export?
