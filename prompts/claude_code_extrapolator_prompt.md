# Claude Code Extrapolator Prompt
...
Convert a Claude Code task transcript into a `BehavioralWindow` that preserves the EDAMAME `SessionPrediction` schema:
...
1. Claude Code is the reasoning plane only. Do not invent observed system facts.
