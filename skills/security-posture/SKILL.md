...
1. Call `edamame_claude_code_control_center` to verify EDAMAME is paired and reachable.
...
- If the EDAMAME endpoint is unreachable, guide the user to run `edamame_claude_code_control_center` for pairing diagnostics.
